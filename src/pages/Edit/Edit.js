...
const Edit = () => {
 ...
 const navigate = useNavigate();
  ...
  const submitUserData = async(e) => {
    ...
    const { fname, lname, email, phoneNumber, gender, location } = inputdata;
    ...
    if (fname === "") {
      ...
      console.log(response,'response in edit of formdata')
      if(response.status === 200){
            ...
            <Form>
              <Row>
                ...
                <Form.Group className="mb-3 col-lg-6" controlId="formBasicEmail">
                  ...
                  <Form.Control type="text" name='phoneNumber' value={inputdata.phoneNumber} onChange={setInputValue} placeholder='Enter Mobile' />
                </Form.Group>
                <Form.Group className="mb-3 col-lg-6" controlId="formBasicEmail">
